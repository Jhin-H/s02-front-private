...
// 멤버 회원구분 수정
const updateMemberTp = async (memberId) => {
    const res = await axios.post('/rest/v1/s021100030/update-member-tp', memberId);
    return res.status
}
// 멤버 삭제
...
export { retrieveMemberList, registerMember, updateMemberInfo, updateMemberTp, deleteMember };